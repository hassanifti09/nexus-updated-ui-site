        ...
        <div className="w-[60%] flex items-center justify-center">
          <div className="w-min flex flex-row justify-between items-center gap-12 font-light text-lg rounded-full bg-white/20 backdrop-blur-sm border-[1px] border-white/30 text-white px-8 py-3">
            ...
            <div className="relative group flex flex-col items-center">
              ...
              <div className="absolute mt-12 text-center w-48 bg-white/20 backdrop-blur-sm border-[1px] border-white/30 rounded-md shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <Link href="/services/cloud-consulting" className="block px-4 py-2 text-white cursor-pointer">Cloud Consulting</Link>
                <Link href="/services/enterprise-software-development" className="block px-4 py-2 text-white cursor-pointer">Software Development</Link>
                <Link href="/services/web-development" className="block px-4 py-2 text-white cursor-pointer">Web Development</Link>
                <Link href="/services/ai-ml-consulting" className="block px-4 py-2 text-white cursor-pointer">AI & ML Consulting</Link>
                <Link href="/services/mobile-development" className="block px-4 py-2 text-white cursor-pointer">Mobile Development</Link>
                <Link href="/services/erp-consulting" className="block px-4 py-2 text-white cursor-pointer">ERP Consulting</Link>
              </div>
            </div>
